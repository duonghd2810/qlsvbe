...
public class UserController extends BaseController<User> {
    ...
    public ResponseEntity<?> forgotPass(@RequestBody UsernameDTO usernameDTO){
        return ResponseEntity.status(HttpStatus.OK.value()).body(userService.forgotPass(usernameDTO));
    }
